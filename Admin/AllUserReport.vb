...
Public Class AllUserReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OOP_Project_Health_Symptom_Analysis.AllUserReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllUserReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllUserReport = New AllUserReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
