...
Public Class FeedbackReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OOP_Project_Health_Symptom_Analysis.FeedbackReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Message() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFeedbackReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FeedbackReport = New FeedbackReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
